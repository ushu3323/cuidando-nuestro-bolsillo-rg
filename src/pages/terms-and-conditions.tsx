    ...
    <main>
      <Container maxWidth="sm" className="mb-10">
        ...
        <p className="mb-10 text-justify">
          Bienvenido a &quot;Precios RG&quot;, una plataforma donde los usuarios
          pueden registrar y compartir información sobre precios de productos en
          distintos comercios. Antes de utilizar nuestra aplicación, por favor
          lee detenidamente estos términos y condiciones.
        </p>
        ...
        <p className="mb-12 text-justify">
          ...
          mismo, según lo solicitado en el formulario de registro. Eres
        ...
        <p className="mb-12 text-justify">
          ...
          se hace responsable por la veracidad de la información proporcionada
          por los usuarios.
        </p>
        ...
        <p className="mb-12 text-justify">
          ...
          aplicación, aceptas el tratamiento de tus datos personales de acuerdo
        ...
        <p className="mb-12 text-justify">
          ...
          pérdida de beneficios, datos o uso, derivados del uso o la
          imposibilidad de usar la aplicación.
        </p>
